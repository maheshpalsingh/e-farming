...
<form  method="post" action="<?php echo site_url('admin/Admin/edittag/'.$taginfo[0]->tagid.'/'.$categoryid)?>" novalidate>
<div class="form-group row">
<label class="col-sm-2 col-form-label">Enter Tag name</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="usernameP" name="tagname" placeholder="Enter Username" value="<?php echo $taginfo[0]->tagname?>">
