...
<li class="breadcrumb-item"><a href="<?php echo site_url('admin/Admin/userview/')?>">User</a>
</li>
</ul>
</div>
</div>
...
<td><img src="<?php echo base_url('resources/shared/customerimg/'.$u->profilepic)?>" height="75px" width="75px  "></td>
</tr>
<?php } ?>
