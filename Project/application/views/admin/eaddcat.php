...
<form  method="post" action="<?php echo site_url('admin/Admin/editcategory/'.$catinfo[0]->categoryid)?>" novalidate>
<div class="form-group row">
<label class="col-sm-2 col-form-label">Enter Category name</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="usernameP" name="categoryname" placeholder="Enter Username"  value="<?php echo $catinfo[0]->categoryname?>">
