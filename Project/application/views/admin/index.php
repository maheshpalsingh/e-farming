...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('resources/admin/');?>assets/css/font-awesome-n.min.css">

<link rel="stylesheet" href="<?php echo base_url('resources/admin/');?>bower_components/chartist/css/chartist.css" type="text/css" media="all">

<link rel="stylesheet" type="text/css" href="<?php echo base_url('resources/admin/');?>assets/css/style.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('resources/admin/');?>assets/css/widget.css">
		...
		<div class="navbar-wrapper">
			...
			<div class="navbar-container container-fluid">
				...
				<i class="feather icon-search input-group-text"></i>
					...
					<li>
<a href="#!" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:toggleFullScreen()" class="waves-effect waves-light" data-cf-modified-e1c0f2a2119936e00327192c-="">
...
<li>
<div class="media">
<img class="img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-4.jpg" alt="Generic placeholder image">
...
<li>
<div class="media">
<img class="img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-3.jpg" alt="Generic placeholder image">
<div class="media-body">
...
<div class="dropdown-primary dropdown">
<div class="dropdown-toggle" data-toggle="dropdown">
<img src="<?php echo base_url('resources/admin/');?>assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
<span>John Doe</span>
...
<li>
<a href="<?php echo site_url('admin/Admin/login')?>">
...
<img class="media-object img-radius img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-3.jpg" alt="Generic placeholder image ">
...
<a class="media-left" href="#!">
 <img class="media-object img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-2.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-4.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-3.jpg" alt="Generic placeholder image">
...
<img class="media-object img-radius img-radius m-t-5" src="<?php echo base_url('resources/admin/');?>assets/images/avatar-2.jpg" alt="Generic placeholder image">
</a>
...
<img src="<?php echo base_url('resources/admin/');?>assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
</div>
<div class="col p-l-5">
...
<td>Sofa</td>
<td>#PHD001</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="38595a5b785f55595154165b5755">[email&#160;protected]</a></td>
...
<td>Computer</td>
<td>#PHD002</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bedddaddfed9d3dfd7d290ddd1d3">[email&#160;protected]</a></td>
...
<td>Mobile</td>
<td>#PHD003</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2757565567404a464e4b0944484a">[email&#160;protected]</a></td>
<td><label class="label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Coat</td>
<td>#PHD004</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5c7c6d6e5c2c8c4ccc98bc6cac8">[email&#160;protected]</a></td>
<td><label class="label label-success">In Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Watch</td>
<td>#PHD005</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1e7d7a7d5e79737f7772307d7173">[email&#160;protected]</a></td>
<td><label class="label label-success">In Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<td>Shoes</td>
<td>#PHD006</td>
<td><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c2b2b3b082a5afa3abaeeca1adaf">[email&#160;protected]</a></td>
<td><label class="label label-danger">Out Stock</label></td>
<td>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
<a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
...
<script data-cfasync="false" src="echo base_url('resources/admin/');?>assets/js/email-decode.min.js"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>bower_components/jquery/js/jquery.min.js"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>bower_components/jquery-ui/js/jquery-ui.min.js"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>bower_components/popper.js/js/popper.min.js"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>bower_components/bootstrap/js/bootstrap.min.js"></script>

<script src="<?php echo base_url('resources/admin/');?>assets/pages/waves/js/waves.min.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>

<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>

<script src="<?php echo base_url('resources/admin/');?>assets/pages/chart/float/jquery.flot.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/pages/chart/float/jquery.flot.categories.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/pages/chart/float/curvedLines.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/pages/chart/float/jquery.flot.tooltip.min.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>

<script src="<?php echo base_url('resources/admin/');?>bower_components/chartist/js/chartist.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>

<script src="<?php echo base_url('resources/admin/');?>assets/pages/widget/amchart/amcharts.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/pages/widget/amchart/serial.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/pages/widget/amchart/light.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>

<script src="<?php echo base_url('resources/admin/');?>assets/js/pcoded.min.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script src="<?php echo base_url('resources/admin/');?>assets/js/vertical/vertical-layout.min.js" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>assets/pages/dashboard/custom-dashboard.min.js"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript" src="<?php echo base_url('resources/admin/');?>assets/js/script.min.js"></script>

<script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="e1c0f2a2119936e00327192c-text/javascript"></script>
<script type="e1c0f2a2119936e00327192c-text/javascript">
...
<script src="<?php echo base_url('resources/admin/');?>assets/js/rocket-loader.min.js" data-cf-settings="e1c0f2a2119936e00327192c-|49" defer=""></script>
</body>
