...
<body class="preload login-page"  onload="ab()">
    ...
    <section class="login_area section--padding2">
        <div class="container">
                      <a href="<?php echo site_url('User')?>" color="red"> <- Back to Home</a>
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <form action="<?php echo site_url('User/validate');?>" method="post">
                        <div class="cardify login">
                            <div class="login--header">
                                <h3>Customer! Welcome Back</h3>
                            ...
                            <div class="login--form">
                                ...
                                <div class="login_assist">
                                    <p ><a href="<?php echo site_url('User/forgot');?>">Forgot Password Or Username</a></p> 
