...
<head>
    ...
    <title>Pocketfarm -Profile </title>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="product product--card">
                               ...
                               <table border="1 solid" bgcolor="lightyellow" width="100%">
                                   <tr>
                                       <td colspan="2"><img src="<?php echo base_url('resources/shared/farmerimg/'.$data->profileimage);?>" height="400px" width="300px" ></td>
                                   </tr>
                                   <tr>
