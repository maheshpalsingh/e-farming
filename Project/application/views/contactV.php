...
<!-- Mirrored from aazztech.com/demos/themes/html/martplace/dist/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 May 2020 06:35:17 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Pocketfarm - Contact us</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="section-title">
                                ...
                                <p>We are a Responsible team trying our best to meet your demands as soon and efficiently as possible. You can contact us for any query ,complaints and feedbacks.</p>
                            </div>
                        </div>
                        <!-- end /.col-md-12 -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="contact_tile">
                                ...
                                <div class="tiles__content">
                                    <p>Department of ICT ,VNSGU, Vesu </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="contact_tile">
                                ...
                                <div class="tiles__content">
                                    <p>Nandakrishnan Nair 9327547985</p>
                                    <p>Kishan Vala 6353806014</p>
                                    <p>MaheshPalSingh Jadon 8200168580</p>
                                </div>
                            </div>
                            <!-- end /.contact_tile -->
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="contact_tile">
                                ...
                                <h4 class="tiles__title">Email ID</h4>
                                <div class="tiles__content">
                                    <p>pocketfarmpvt@gmail.com</p>
